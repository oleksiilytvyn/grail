...
class ShadowDialog(BalloonDialog):
    ...
    def initUI( self ):
        ...
        self.ui_blur_slider = QSlider( Qt.Horizontal )
        self.ui_blur_slider.setRange( 0, 100 )
        self.ui_blur_slider.setValue( self.blur )
        self.ui_blur_slider.valueChanged.connect( self.sliderChanged )
        ...
        self.ui_controls_layout.addWidget( QLabel('Blurriness'), 2, 0, 1, 2 )
        self.ui_controls_layout.addWidget( self.ui_blur_slider, 3, 0, 1, 2 )
        ...
        self.setGeometry( 100, 300, 240, 190 )
    ...
    def sliderChanged( self, value ):
        ...
        self.blur = self.ui_blur_slider.value()
